...
export function LeaderboardRowDesktop({
  ...
  const renderAvatar = () => {
    if (mode === 'singles') {
      ...
      return avatar ? (
        <img src={avatar} alt={name} className={cn("w-10 h-10 rounded-full object-cover transition-transform duration-200 group-hover:scale-105 shrink-0 ring-2 ring-background bg-[#1a1f2e]", rank <= 3 && "shadow-[0_0_12px_-2px_hsl(45,93%,58%,0.3)]")} />
      ) : (
    ...
    if (players) {
      ...
      return <div className="flex items-center -space-x-2 shrink-0">
          {avatar1 ? (
            <img src={avatar1} alt={players[0]} className="w-10 h-10 rounded-full object-cover ring-2 ring-background z-10 transition-transform duration-200 group-hover:scale-105 bg-[#1a1f2e]" />
          ) : (
          ...
          {avatar2 ? (
            <img src={avatar2} alt={players[1]} className="w-10 h-10 rounded-full object-cover ring-2 ring-background transition-transform duration-200 group-hover:scale-105 bg-[#1a1f2e]" />
          ) : (
...
export function LeaderboardRowMobile({
  ...
  const renderAvatar = () => {
    if (mode === 'singles') {
      const avatar = getPlayerAvatar(name);
      return avatar ? (
        <img src={avatar} alt={name} className={cn("w-7 h-7 rounded-full object-cover shrink-0 bg-[#1a1f2e]", rank <= 3 && "shadow-[0_0_8px_-2px_hsl(45,93%,58%,0.3)]")} />
      ) : (
    ...
    if (players) {
      ...
      return <div className="flex items-center -space-x-1.5 shrink-0">
          {avatar1 ? (
            <img src={avatar1} alt={players[0]} className="w-7 h-7 rounded-full object-cover ring-2 ring-background z-10 bg-[#1a1f2e]" />
          ) : (
          ...
          {avatar2 ? (
            <img src={avatar2} alt={players[1]} className="w-7 h-7 rounded-full object-cover ring-2 ring-background bg-[#1a1f2e]" />
          ) : (
