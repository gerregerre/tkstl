...
export function HeroSection({ onScrollDown }: HeroSectionProps) {
  return (
    <section className="relative w-screen min-h-[80vh] sm:h-screen -ml-[calc((100vw-100%)/2)] left-0 overflow-hidden">
      {/* Background Image */}
      <div
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center sm:px-6 px-px py-[160px]">
        ...
        <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/30 rounded px-3 sm:px-4 py-1.5 mb-6 sm:mb-8 animate-fade-in">
          ...
          <span className="text-primary font-bold tracking-widest text-[10px] sm:text-xs uppercase">Est. 2017</span>
        </div>

        {/* Main Heading - Bold Montserrat */}
        <h1
          className="font-display text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-foreground mb-1 sm:mb-2 animate-fade-in tracking-tight uppercase drop-shadow-lg"
          style={{
            animationDelay: "0.1s",
          }}
        >
        ...
        <h2
          className="font-display text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-gradient-cyan mb-6 sm:mb-8 animate-fade-in tracking-tight uppercase drop-shadow-lg"
          style={{
            animationDelay: "0.2s",
          }}
        >
        ...
        {/* Subheading */}
        <p
          className="text-muted-foreground max-w-xs sm:max-w-lg md:max-w-2xl mx-auto text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mb-8 sm:mb-12 animate-fade-in font-medium px-4 drop-shadow-sm"
          style={{
            animationDelay: "0.3s",
          }}
        >
