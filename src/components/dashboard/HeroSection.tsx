...
export function HeroSection({
  ...
  return <section className="relative w-screen min-h-[80vh] sm:h-screen -ml-[calc((100vw-100%)/2)] left-0 overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center sm:px-6 px-px py-[160px]">
        ...
        {/* Club Name - with shimmer animation */}
        <p style={{
        animationDelay: '0.1s'
      }} className="font-display text-lg sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-4 animate-fade-in tracking-wide uppercase not-italic drop-shadow-lg text-muted-foreground lg:text-5xl animate-shimmer bg-clip-text">TENNISKLUBBEN STORA TENNISLIGAN</p>
