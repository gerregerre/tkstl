      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-center justify-center gap-3">
          {(() => {
            ...
            return avatar1 ? (
              <img src={avatar1} alt={lastTeam.player1} className="w-12 h-12 rounded-full avatar-circle-bg ring-2 ring-amber-500/30 shadow-[0_0_16px_-4px_hsl(38,92%,50%,0.3)]" />
            ) : (
          ...
          {(() => {
            ...
            return avatar2 ? (
              <img src={avatar2} alt={lastTeam.player2} className="w-12 h-12 rounded-full avatar-circle-bg ring-2 ring-rose-500/30 shadow-[0_0_16px_-4px_hsl(350,80%,55%,0.3)]" />
            ) : (
